const emailTranslations = {
  lt: {
    ...
    greeting: "Sveiki",
    receivedMessage:
      "Gavome jūsų užklausą dėl apartamentų ir netrukus su jumis susisieksime.",
  ...
  en: {
    ...
    greeting: "Hello",
    receivedMessage:
      "We received your inquiry about apartments and will contact you soon.",
  ...
  ru: {
    ...
    receivedMessage:
      "Мы получили ваш запрос об апартаментах и свяжемся с вами в ближайшее время.",
